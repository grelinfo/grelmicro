"""Pure-ASGI binding middleware for the `Grelmicro` app.

Sits at the top level rather than under an integration: it imports nothing
from a web framework and runs in front of any ASGI app. `micro.install(app)`
adds it for the frameworks grelmicro knows, and an app on any other one wraps
itself with it.
"""
