...
Everything pure ASGI lives in [Starlette](starlette.md) and is re-exported
here, so a FastAPI app needs one import either way. This module adds what
only FastAPI has: the OpenAPI schema and the health router.
