...
structlog with orjson reaches roughly 300,000 records per second against 147,000 for loguru with stdlib json. [Benchmarks](benchmarks.md#logging) has the full table, and [Logging](logging/index.md#which-serializer-you-get) covers the one value the two serializers write differently.
