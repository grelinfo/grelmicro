...
* 🐛 `Match | other` and `Match & other` raise `TypeError` when the other side is not a `Match`, instead of building a combination that fails later. ([#782](https://github.com/grelinfo/grelmicro/pull/782))
