...
* ✨ A header name that is not an HTTP field name raises `SettingsValidationError` when the component is built, instead of reaching the wire as a broken header. ([#688](https://github.com/grelinfo/grelmicro/issues/688))
