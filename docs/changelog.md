...
* ✨ A rejection carrying `headers` puts them on the answer, so what a refusal has to tell the client travels with the status. ([#739](https://github.com/grelinfo/grelmicro/issues/739))
