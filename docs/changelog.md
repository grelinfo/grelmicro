...
* 📝 Add a Mermaid state diagram to the Circuit CircuitBreakers page.
...
* ✨ Add Circuit CircuitBreakers resilience pattern. PR [#18](https://github.com/grelinfo/grelmicro/pull/18).
