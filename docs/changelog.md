...
* 📝 Say in the [contributing checklist](https://github.com/grelinfo/grelmicro/blob/main/CONTRIBUTING.md#before-opening-a-pr) that the roadmap holds direction and the issue tracker holds the queue. No issue numbers on the roadmap, and no roadmap edit for ordinary work one of its headings already covers. ([#647](https://github.com/grelinfo/grelmicro/issues/647))
