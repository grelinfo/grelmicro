...
* ✨ A field holding a set of paths reads a comma-separated list as well as a JSON one, so `GREL_ACCESS_LOG_EXCLUDE=/livez,/readyz` works in a ConfigMap. ([#813](https://github.com/grelinfo/grelmicro/issues/813))
